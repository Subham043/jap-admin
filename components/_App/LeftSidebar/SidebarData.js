...
import createSvgIcon from "@mui/icons-material/ProductionQuantityLimits";
export const SidebarData = [
  ...
  /*PRODUCTS*/
  {
    ...
    subNav: [
      ...
      {
        title: "Coupon",
        path: "/products/coupon",
      },
      {
        title: "Pincode",
        path: "/products/pincode",
      },
      {
        title: "Enquiry",
        path: "/products/enquiry",
      },
      {
        title: "Excel Upload",
        path: "/products/excel",
      ...
      ,
      {
        ...
        path: "/products/gallery-categories",
      },
    ],
  } /*
  {
